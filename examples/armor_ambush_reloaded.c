...
const char playfield_valregs[384] = {
    ...
    REG_COLUPF, VCS_WHITE, REG_PF2, 0xaa, REG_PF1, 0x55, REG_PF0, 0xa0, REG_CTRLPF, 0x00, REG_COLUBK, VCS_BROWN, REG_COLUPF, VCS_BROWN, REG_COLUBK, VCS_LGREEN, 
    // The road again
...
const char playfield_special[48] = {
    2, 2, 2, 0x15, 1, 1, 1, 1, 0x15, 2, 2, 2, 2, 2, 2, 0x14, 0x14, 0, 0, 0, 2, 2, 2, 2, 0, 0xc, 0xc, 0, 0, 0, 1, 1, 1, 0, 0x14, 0x14, 0, 0x14, 0x14, 0, 1, 1, 1, 0, 0, 0, 0, 0
};
