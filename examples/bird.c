...
const bank3 unsigned char flappybird0[16] = { 0x00, 0x00, 0x00, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0xc6, 0xf6, 0xf6, 0xf6, 0xc6, 0xf6, 0xf6, 0x76 };
const bank3 unsigned char flappybird1[16] = { 0x03, 0x03, 0x03, 0x3b, 0x7b, 0xda, 0xda, 0xda, 0xda, 0xda, 0xda, 0x7b, 0x3b, 0x00, 0x00, 0x00 };
const bank3 unsigned char flappybird2[16] = { 0x18, 0x18, 0x18, 0x9c, 0xde, 0xd6, 0xd6, 0xd6, 0xd6, 0xd6, 0xd6, 0xde, 0x9c, 0x00, 0x00, 0x00 };
const bank3 unsigned char flappybird3[16] = { 0x30, 0x38, 0x18, 0x3b, 0x7b, 0xdb, 0xdb, 0xdb, 0xdb, 0xdb, 0xdb, 0xdb, 0xdb, 0x03, 0x03, 0x03 };
const bank3 unsigned char flappybird4[16] = { 0x00, 0x00, 0x00, 0x9b, 0xdb, 0x5b, 0x5b, 0xdb, 0x9b, 0xdb, 0x43, 0x59, 0x58, 0x40, 0xc0, 0x80 };
const bank3 unsigned char flappybird5[16] = { 0x00, 0x00, 0x00, 0x0f, 0x1f, 0x1b, 0x1b, 0x1b, 0x1b, 0xdb, 0xdb, 0xdf, 0xcf, 0x03, 0x03, 0x03 };

bank3 void display_flappybird()
{
    strobe(WSYNC);
    strobe(HMOVE);
    *COLUBK = BLACK;
...
const bank3 unsigned char getready0[16] = { 0x00, 0x00, 0x00, 0x38, 0x79, 0xdb, 0xdb, 0xdb, 0xdb, 0xdb, 0xdb, 0xc3, 0xc3, 0xf9, 0x78, 0x38 };
const bank3 unsigned char getready1[16] = { 0x00, 0x00, 0x00, 0x83, 0x87, 0x86, 0x86, 0xe6, 0x66, 0x66, 0x6f, 0x6f, 0xef, 0xc6, 0x06, 0x06 };
const bank3 unsigned char getready2[16] = { 0x00, 0x00, 0x00, 0x36, 0x36, 0x3c, 0x3c, 0x3c, 0x36, 0x36, 0x36, 0x36, 0x36, 0x36, 0x3e, 0x3c };
const bank3 unsigned char getready3[16] = { 0x00, 0x00, 0x00, 0x20, 0x61, 0xe3, 0xe3, 0xfb, 0xdb, 0xdb, 0xdb, 0xd9, 0xf8, 0x70, 0x00, 0x00 };
const bank3 unsigned char getready4[16] = { 0x00, 0x00, 0x00, 0xe7, 0xef, 0x6b, 0x6b, 0x6b, 0x6b, 0x6b, 0x6b, 0xef, 0xe7, 0x03, 0x03, 0x03 };
const bank3 unsigned char getready5[16] = { 0x70, 0x78, 0x18, 0x1b, 0x3b, 0x78, 0x7b, 0x5b, 0x5b, 0x5b, 0x5b, 0x5b, 0x5b, 0x03, 0x03, 0x03 };

bank3 void display_getready()
{
    strobe(WSYNC);
    strobe(HMOVE);
    *COLUBK = BLACK;
