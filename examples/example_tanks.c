...
char *shell_mask_ptr;
char *missile_and_ball_mask0, *missile_and_ball_mask1;
...
const unsigned char missile_and_ball_mask[14 + KERNAL] = { 
...
// Generated by build_shell_directions.c. Takes into account a 1.6 pixel ratio between vertical and horizontal
...
void init()
{
    ...
    *COLUPF = VCS_BLACK; 
    ...
    playfield_valreg_ptr = playfield_valregs;
}
    ...
    *COLUBK = VCS_LGREEN;
    ...
    for (Y = 1; Y >= 0; Y--) {
        ...
        if (Y) {
            ...
            missile_and_ball_mask1 = missile_and_ball_mask - ypos_second_tank[Y];
        } else {
            ...
            missile_and_ball_mask0 = missile_and_ball_mask - ypos_second_tank[Y];
        }
    ...
    shell_mask_ptr = missile_and_ball_mask - 1 - i;
}
    ...
    while(1) {
        ...
        *VBLANK = 0;
        ...
        do {
            ...
            *NUSIZ0 = (*ENAM0 = missile_and_ball_mask0[Y]) & 0xf0;
            Y--;
            ...
            *ENABL = shell_mask_ptr[Y] << 1;
            *GRP1 = sprite_ptr1[Y] & mask_ptr1[Y];
            *NUSIZ1 = (*ENAM1 = missile_and_ball_mask1[Y]) & 0xf0;
